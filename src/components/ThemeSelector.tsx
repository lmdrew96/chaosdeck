...
export default function ThemeSelector() {
  ...
  return (
    <header className="fixed inset-x-4 top-4 z-50">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 rounded-[18px] border border-foreground/15 bg-background/90 px-4 py-3 shadow-[0_24px_60px_rgba(0,0,0,0.24)] backdrop-blur-md">
        <Link href="/" className="flex items-center gap-3" aria-label="ChaosDeck home">
          <span className="flex h-10 w-10 items-center justify-center rounded-full border border-foreground/15 bg-background/70 shadow-inner shadow-black/10">
            <SwordIcon />
          </span>
          <span className="flex flex-col">
            <span className="font-semibold tracking-tight text-orchid-hush">ChaosDeck</span>
            <span className="font-mono text-[10px] uppercase tracking-[0.28em] text-ash-grey/80">MTG deckbuilder</span>
          </span>
        </Link>
